...
export type TechnicalSpecs = {
  ...
  ch4_factor_gasolina_c: number;
  ch4_factor_diesel_s10: number;
  ch4_factor_etanol: number;
  ch4_factor_gnv: number;
  n2o_factor_gasolina_c: number;
  n2o_factor_diesel_s10: number;
  n2o_factor_etanol: number;
  n2o_factor_gnv: number;
  gwp100_ch4: number;
  gwp100_n2o: number;
  ...
  idle_rate_gnv: number;
  idle_rate_eletrico: number;
